 ...
 */
public interface VscConverterStation extends HvdcConverterStation<VscConverterStation> {
     ...
     * @param targetV the voltage setpoint target
     * @return the converter itself to allow method chaining
     */
    HvdcConverterStation setTargetV(float targetV);
     ...
     * @param targetQ the reactive power setpoint target
     * @return the converter itself to allow method chaining
     */
    HvdcConverterStation setTargetQ(float targetQ);
}
