...
public class VscTest {
    ...
    public void testBase() {
        ...
        assertTrue(cs1.getTargetV() == 405f);
        assertTrue(Float.isNaN(cs1.getTargetQ()));
        assertFalse(cs2.isVoltageRegulatorOn());
        assertTrue(cs2.getTargetQ() == 123f);
        assertTrue(Float.isNaN(cs2.getTargetV()));
