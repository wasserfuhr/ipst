...
public class HvdcLineAdderImpl extends IdentifiableAdderImpl<HvdcLineAdderImpl> implements HvdcLineAdder {
    ...
    @Override
    public HvdcLineAdder setTargetP(float targetP) {
    ...
    @Override
    public HvdcLineAdder setInService(boolean inService) {
    ...
    public HvdcLine add() {
        ...
        ValidationUtil.checkInService(this, inService);
        ...
        HvdcLineImpl hvdcLine = new HvdcLineImpl(id, name, r, nominalV, maxP, convertersMode, targetP, inService,
